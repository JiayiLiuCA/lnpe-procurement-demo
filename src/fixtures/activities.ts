...
export const activities: Activity[] = [
  { id: "a-1", projectId: "p-20260510", text: "锋杰合同交货逾期 5 天，已生成催发货提醒", at: "08-20 09:00", actor: "系统", tone: "danger" },
  ...
  // 其余项目各给少量动态
  { id: "a-8", projectId: "p-260227", text: "催发货短信已发送卖方经办 唐毅", at: "08-18 10:22", actor: "赵小燕", tone: "danger" },
